...
const CloseButton = ({onClickBtn , className , containerClassName , isAnimation=true} : {onClickBtn?: () => void , className?:string , containerClassName?: string , isAnimation?: boolean}) => {
  return (
    <HoverBorderGradient isAnimation={isAnimation} onClick={onClickBtn} className={cn("p-2 flex justify-center items-center dark:bg-black bg-white-800 text-black dark:text-white", containerClassName)}>
