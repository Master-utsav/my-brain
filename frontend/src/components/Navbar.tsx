...
const Navbar: React.FC= () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-40 backdrop-blur-lg w-[80%] sm:max-w-7xl mx-auto dark:bg-black-300/20 bg-white-700/20 rounded-lg my-2">
      <div className="max-w-full sm:py-2 ">
        <div className="flex sm:flex-row flex-col justify-between px-5 items-center font-noto-sans xl:gap-20 md:gap-5 gap-3">
