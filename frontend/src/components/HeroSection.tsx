...
const HeroSection: React.FC = () => {
  ...
  return (
    <section className="flex w-full relative flex-col items-center justify-center min-h-screen transition-colors duration-300 mx-auto bg-dot-[#2a7ea9]/[0.5] dark:bg-dot-[#2a7ea9]/[0.4] sm:py-16 pt-24">
